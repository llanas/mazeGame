...
export default class Door extends PhysicalRectangle {
    ...
    constructor(_position: Position, _isVertical: boolean, _isOpenable: boolean) {
        if(_isVertical) _position.x--;
        else _position.y--;
        super(_position, false, true, (_isVertical) ? doorWidth : Constants.gridSquareSize + 1, (_isVertical) ? Constants.gridSquareSize + 1 : doorWidth);
